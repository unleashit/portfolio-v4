...
export type Project = {
  ...
  description?: string | null;
  image_logo?: string | DirectusFiles | null;
  image_main?: string | DirectusFiles | null;
  ...
  sort: number;
  status: string;
  tag?: any[] | ProjectProjectTags[] | null;
  title: string;
};

export type ProjectProjectTags = {
  id: number;
  project_project_id?: string | Project | null;
  project_tags_tag_id?: string | ProjectTags | null;
};
...
export type CustomDirectusTypes = {
  ...
  project: Project;
  project_project_tags: ProjectProjectTags;
